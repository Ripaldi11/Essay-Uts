...
class JwbUts {
    private ArrayList<DataZakatUts> dataWarga;
    public static void main(String[] args) throws Exception {
        JwbUts Screen = new JwbUts();
        Screen.inputData();
        Screen.cetakData();
    }

    public void inputData() {
        dataWarga = new ArrayList<DataZakatUts>();
        String jawaban;
        int number = 1;
        do {
            ...
            DataZakatUts warga = new DataZakatUts(nama, alamat, metodePembayaran);
            dataWarga.add(warga);
